		...
		if (FD_ISSET(uds_conn, &readfds)) {
			...
			if (bytes_read > 0) {
				...
				if (bytes_read >= 13 && bytes_read <= (6 + 239)) {
					...
					uint8_t data[BASE_DATA_LEN + MAX_PAYLOAD_LEN];
					uint8_t base_data[BASE_DATA_LEN] = {
						0x00, 0x00, 0x26, 0x00, 0x2f, 0x40, 0x00, 0xa0,
						0x20, 0x08, 0x00, 0xa0, 0x20, 0x08, 0x00, 0x00,
						0xdf, 0x32, 0xfe, 0x1f, 0x00, 0x00, 0x00, 0x00,
						0x10, 0x0c, 0x6c, 0x09, 0xc0, 0x00, 0xd3, 0x00,
						0x00, 0x00, 0xd3, 0x00, 0xc7, 0x01, 0xd0, 0x00,
						0x3a, 0x01, 0x58, 0xbf, 0x25, 0x82, 0x8e, 0xd8,
						0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x58, 0xbf, 
						0x25, 0x82, 0x8e, 0xd8, 0x70, 0x51, 0x7f, 0x18,
